...
--
-- Host: 127.0.0.1
-- Creato il: Gen 25, 2025 alle 10:02
...
CREATE TABLE `consegue` (
  ...
  `rif_proposta` bigint(20) NOT NULL,
  `rif_bozza` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `effettua` (
  ...
  `rif_docente` bigint(20) NOT NULL,
  `rif_bozza` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `insegnamento` (
  `coord` tinyint(1) NOT NULL,
  `rif_docente` bigint(20) NOT NULL,
  `rif_classe` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `partecipa` (
  ...
  `rif_viaggio` bigint(20) NOT NULL,
  `rif_classe` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
